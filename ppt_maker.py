...
def read_excel_data(file_path):
    ...
    selected_columns = ['이름', '이메일', '사진', '스펙', '문항1 점수', '문항2 점수', '문항3 점수', '합불 여부']
...
def create_ppt_from_excel(file_path):
    # 엑셀 파일에서 데이터를 읽어옵니다.
    ...
    # 결과 저장
    prs.save('inbound_result_report.pptx')

# 엑셀 파일 경로
excel_file_path = './applicants_data/kpmg_demo.xlsx'
